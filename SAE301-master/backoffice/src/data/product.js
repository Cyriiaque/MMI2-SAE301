...
let fakeProducts = [
  {
    ...
    id_products: 2,
    image:
      "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/d56ebd9e-15f9-4aa3-9e52-c23f5b5c5930/M+NK+DF+STRK+TOP+SS.png",
  },
  {
    id: 2,
    name: "Lait",
...
ProductData.create = async function (formdata) {
  let data = await postRequest("products/add", formdata);
  return data;
};
