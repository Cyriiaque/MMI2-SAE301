...
class Cart implements JsonSerializable {
    ...
    public function JsonSerialize(): mixed{
        return ["id_order" => $this->id_order, "id_product" => $this->id_product, "quantity" => $this->quantity, "promo" => $this->promo, "name" => $this->name, "subtitle" => $this->subtitle, "price" => $this->price, "image" => $this->image, "stock" => $this->stock];
    }
