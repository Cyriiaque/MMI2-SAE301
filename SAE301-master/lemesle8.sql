...
--
-- Hôte : localhost
-- Généré le : dim. 20 oct. 2024 à 19:00
...
(2, 'Nike Pegasus', 'Chaussure de trail imperméable pour homme', 'Spécialement conçue pour le trail en hiver, la Pegasus Trail 5 protège des intempéries. Empeigne imperméable en GORE-TEX. Semelle extérieure tout-terrain. Motifs réfléchissants. Tu as tout pour affronter confortablement les éléments. Si tu ajoutes une semelle intermédiaire en mousse ReactX, tu obtiens un amorti réactif pour une foulée dynamique.', 159.99, 'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/b1b4e4da-d5fa-47ca-87df-d51d96bdd035/NIKE+PEGASUS+TRAIL+5+GTX.png', 'Chaussures', 'homme', 'grey', '43', NULL, 5, '20'),
...
--
ALTER TABLE `Cart_products`
  MODIFY `id_cart_product` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
