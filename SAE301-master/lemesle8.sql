...
--
-- Hôte : localhost
-- Généré le : ven. 25 oct. 2024 à 17:03
...
CREATE TABLE `Orders` (
  ...
  `date` date NOT NULL,
  `statut` enum('en cours','disponible','annulée','retirée') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `Orders` (`id_order`, `id_user`, `date`, `statut`) VALUES
(1, 1, '2024-10-23', 'en cours'),
(2, 1, '2024-10-18', 'en cours');
...
(20, 'Lemeslelele', 'groscaca', 'fp.lajudie@gmail.com', '$2y$10$2TTTk8VGW.KOCcpXhJ5vq.7mY9Gld3fda2lRqsTSBQCFcvVyN7EwC');
...
--
ALTER TABLE `Cart_products`
  MODIFY `id_cart_product` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
