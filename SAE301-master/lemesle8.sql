...
--
-- Hôte : localhost
-- Généré le : sam. 19 oct. 2024 à 13:22
...
CREATE TABLE `Carts` (
  ...
  `id_cartproducts` int(11) NOT NULL,
...
INSERT INTO `Carts` (`id_carts`, `id_cartproducts`, `id_user`) VALUES
(1, 1, 1);
...
INSERT INTO `Cart_products` (`id_cart_product`, `id_cartproducts`, `id_product`, `quantity`) VALUES
(1, 1, 2, 3),
(2, 1, 3, 1),
(3, 1, 1, 1),
(4, 1, 4, 1),
...
ALTER TABLE `Carts`
  ...
  ADD KEY `id_cartproducts` (`id_cartproducts`),
...
--
ALTER TABLE `Carts`
  MODIFY `id_carts` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `Carts`
  ADD CONSTRAINT `Carts_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `Users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Carts_ibfk_3` FOREIGN KEY (`id_cartproducts`) REFERENCES `Cart_products` (`id_cartproducts`) ON DELETE CASCADE ON UPDATE CASCADE;
